...
#entangled[A.5 is nullified by: ] #entangledRule("CE16.1.4")\
...
- #entangled[Entangled Rule(s):]
- #entangled[D.1.2.n is referenced by: ] #entangledRule("E.1.6.b")
...
F.2.4) The category is timed by RTA.
...
CE16.1.4) <CE16.1.4> The category is timed by RTA.
